...
Feed.destroy_all
  ...
  # {
  #   url: 'https://antontsau.livejournal.com/data/rss',
  #   interval_seconds: 61
  # },
  # {
  #   url: 'https://bruzh.livejournal.com/data/rss',
  #   interval_seconds: 90
  # },
  # {
  #   url: 'https://dma.livejournal.com/data/rss',
  #   interval_seconds: 120
  # },
  # {
  #   url: 'https://dil.livejournal.com/data/rss',
